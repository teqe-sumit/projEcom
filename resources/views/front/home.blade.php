...
<head>
	...
	<meta property="og:title" c$Details = Payment::all();ontent="" />
            ...
            <div class="row">
                @foreach ($categories as $category)
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            @foreach ($category->prod_cat as $product)
                                <!-- Show product only if it has a price -->
                                @if ($product->price)
                                    <div class="col-md-4">
                                        <div class="card product-card">
                                            <div class="product-image position-relative">
                                                ...
                                                <img class="w-100 h-100" src="{{ asset($product->productImage->image) }}" alt="Image">
                                                   ...
                                                   @endif
                                                <a href="{{ route('front.product', $product->title) }}" class="product-img"><img class="card-img-top" src="{{ $product->image }}" alt=""></a>
                                            ...
                                            <div class="card-body text-center mt-3">
                                                ...
                                                <div class="price mt-2">
                                                    ...
                                                    <!-- Optional: Display discounted price -->
                                                    <!-- <span class="h6 text-underline"><del>$120</del></span> -->
                                                </div>
                                            </div>
                                        </div>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
                        Design & Developed By Sumit Sharma
					</div>
				</div>
			</div>
		</div>
